...
<section class="content-area"  id="flight-listing">
    ...
    <div class="col-xl-9 col-lg-10 mx-auto mt-5 mt-xl-0">
      ...
      <div class=" text-white alert bg-success">
        <strong><h6 id="in-out">Select Departure Flight</h6></strong>
        <small>The depature airline selected here should be same same the return airline</small>
      </div>
    </div>
        <div class="col-lg-12 col-md-6">
         <?php  if(empty($flights)){ ?>
          ...
          <?php }
           ...
           foreach($data['aero_crs']['aerocrs']['flights'] as $flights) {
             foreach($flights as $i => $item) {
               if($item['via'] == "" && $item['direction'] =='Outbound'){
                 $nonstop++;
               }
               elseif($item['via'] != "" && $item['direction'] =='Outbound'){
                $connecting++;
               }
               if($item['direction']=='Outbound'){?>
            <div class="flight-list-box rt-mb-30">
                ...
                <!--    <div class="trip">
                    ...
                    <div class="mb-5">
                         ...
                         <form action="flight-Results-rt-in.php" method="POST">
                          <select class="form-control cabin-class classprice" onchange="setprices()" name="flightid1" style="width: 100%" id="<?php echo $item['airlineid'] ?>">
