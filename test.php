                    ...
                    <div class="row">
                      <div class="col-md-4 rt-mb-30">
                        ...
                        <div class="col-md-4 rt-mb-30">
                            ...
                            <input type="tel" name="phone[]" placeholder="254728979121" id="eml-name">
                        </div><!-- /.col-md-6 -->
                        <div class="col-md-4 rt-mb-30">
                        ...
                        <div class="col-lg-4 rt-mb-30">
                            ...
                            <select id="select-2" class="doc-type" name="doc-type[]" onchange="toggleExpiry()">
                        ...
                        <div class="col-lg-8 rt-mb-30">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="doc-number[]" class="form-control" placeholder="" id="doc-number">
                                </div><!-- /.col-md-6 -->
                                <div class="col-md-6">
                                    <label for="exp-date">Expiry Date</label>
                                    <input type="text" name="exp-date[]" class="form-control exp-date" placeholder="YYYY/MM/DD/" >
                                </div><!-- /.col-md-6 -->
                            </div><!-- /.row -->
                        </div><!-- /.col-md-6 -->
               ...
               <div  class="rt-form rt-line-form flight-lable passengers">
                    <div class="row">
                      ...
                      <div class="col-md-3">
                         ...
                         <input type="text" class="form-control has-con child-dob" name="child-dob[]" placeholder="MM/DD/YYYY" id="child-dob">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-3 rt-mb-30">
                        ...
                        <div class="col-md-3">
                           ...
                           <input type="text" name="infant-dob[]" class="form-control has-con infant-dob" placeholder="MM/DD/YYYY" id="infant-dob">
