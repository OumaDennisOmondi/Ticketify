...
//get flights stored in session;
$data['aero_crs']=$_SESSION['return_trip'];
//get routes stored in session
$routes=$_SESSION['routes'];
//chech if flights pcntl_wexitstatus
            ...
            <div class="col-12">
                <div class="breadcrumbs-content">
                    ...
                    <div class="breadcrumbs">
                        ...
                        <a href="#" title="Home"><?php echo $routes[0] ?></a>&nbsp;
                        <span class="divider"><i class="icofont-airplane-alt"></i></span>&nbsp;
                        <span class="divider"><i class="fa fa-map-marker-alt"></i></span> <?php echo $routes[1] ?><br /><br />
...
<section class="content-area"  id="flight-listing">
    ...
    <div class="col-xl-9 col-lg-10 mx-auto mt-5 mt-xl-0">
      ...
      <div class="col-lg-12 col-md-6 " id="in-out-div">
      <div class=" text-white alert bg-success">
        <strong><h6 id="in-out">Select Return Flight</h6></strong>
        <small>The return airline selected here should be same same the depature airline</small>
      </div>
    </div>
        <div class="col-lg-12 col-md-6">
          ...
          <?php }
           elseif(!empty($flights)){
              foreach($data['aero_crs']['aerocrs']['flights'] as $flights) {
             foreach($flights as $i => $item) {
               if($item['via'] == "" && $item['direction'] =='Inbound'){
                 $nonstop++;
               }
               elseif($item['via'] != "" && $item['direction'] =='Inbound'){
                $connecting++;
               }
               if($item['direction']=='Inbound'){?>
            <div class="flight-list-box rt-mb-30">
                ...
                <!--    <div class="trip">
                    ...
                    <div class="mb-5">
                         ...
                         <form action="passenger-details.php" method="POST">
                           <!--get flightid1 -->
                           <input type="hidden" name="flightid1" value="<?php echo $_POST['flightid1']; ?>">
                          <select class="form-control cabin-class classprice" onchange="setprices()" name="flightid2" style="width: 100%" id="<?php echo $item['airlineid'] ?>">
                        ...
                        <button type="submit" class=" rt-btn  pill rt-gradient text-uppercase">Select</button>
                      </form>
                    </div><!-- /.book-now -->
                </div><!-- /.top-content -->
...
<!--
 ...
 <script>
  ...
  function showForm(){
    ...
    document.getElementById(trip).value=true;
